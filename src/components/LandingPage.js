            ...
            <main className="landing_page_bg w-screen h-screen">
                ...
                <div className='flex justify-between items-center '>
                    ...
                    <div className='w-[100%] h-[90vh] flex flex-col-reverse justify-evenly items-center lg:flex-row lg:justify-between lg:items-center lg:w-[85%] lg:h-[89.90vh] lg:mr-[15.5%]'>
                        <div className='w-[90%] lg:w-[46%]  flex-col items-center justify-center md:space-y-7 space-y-5 text-start sm:text-center '>
                            ...
                            <ul className='pt-2 lg:pt-10 flex w-[260px] sm:w-full justify-between sm:justify-evenly items-center'>
                                <li><button className='hover:shadow-md bg-[#16B0B2] text-white px-6 py-2 md:px-8 md:py-4 md:text-xl rounded-full'><Link to='#' target="_hireMe">Hire Me</Link></button></li>
                                <li><button className='hover:shadow-md bg-[#16B0B2] text-white px-6 py-2 md:px-8 md:py-4 md:text-xl rounded-full'><Link to='#' target="_hireMe">Resume</Link></button></li>
                            </ul>
                        </div>
                        <div className='w-[90%] max-w-[400px] lg:w-[42%] md:max-w-[600px] text-center'>
