        ...
        <div>
            <main className="landing_page_bg w-screen h-screen">
                ...
                <div className='flex justify-between items-center'>
                    <div className='w-[14%] h-[89.90vh]'>Social Media Icons</div>
                    <div className='flex justify-between items-center w-[86%] h-[89.90vh] mr-[15.5%]'>
                        <div className='w-[46%] flex-col space-y-4'>
                            ...
                            <ul className='pt-10 flex w-[260px] justify-between items-center'>
                                <li><button className='bg-[#16B0B2] text-white px-6 py-2 rounded-full'><Link to='#' target="_hireMe">Hire Me</Link></button></li>
                                <li><button className='bg-[#16B0B2] text-white px-6 py-2 rounded-full'><Link to='#' target="_hireMe">Resume</Link></button></li>
                            </ul>
                        </div>
