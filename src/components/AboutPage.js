                ...
                <div className='flex justify-around lg:justify-between xl:justify-center items-center w-full '>
                    ...
                    <div className='flex flex-col lg:flex-row justify-evenly xl:justify-between items-center w-full h-fit py-6 lg:w-[85%] lg:h-[64vh] lg:mr-[15.5%] bg-white rounded-3xl lg:space-x-8 md:space-x-6 xl:space-x-10'>
                        ...
                        <div className='pt-2 lg:pt-0 w-[90vw] lg:w-[50%] flex flex-col justify-center items-center space-y-4  lg:space-y-2 xl:space-y-5 bg-white pr-6 text-center'>
                            ...
                            <p className='tracking-normal text-sm md:text-lg text-gray-600 w-[70%] lg:w-full text-center'>Versatile Full-Stack Web Developer with a flair for crafting high-impact applications using the MERN stack, dedicated to delivering optimal digital solutions.</p>
                            ...
                            <ul className='text-gray-600 text-sm md:text-base grid grid-cols-2 gap-3 text-center place-items-center'>
                                <li className='bg-gray-200 rounded-lg w-full justify-center h-[60px] py-1 px-2 sm:py-2 sm:px-2 text-center flex items-center list-none'>Expert in MERN Stack Development</li>
                                <li className='bg-gray-200 rounded-lg w-full justify-center h-[60px] py-1 px-2 sm:py-2 sm:px-2 text-center flex items-center list-none'>Passionate Front-End Innovator</li>
                                <li className='bg-gray-200 rounded-lg w-full justify-center h-[60px] py-1 px-2 sm:py-2 sm:px-2 text-center flex items-center list-none'>Database Management Maestro</li>
                                <li className='bg-gray-200 rounded-lg w-full justify-center h-[60px] py-1 px-2 sm:py-2 sm:px-2 text-center flex items-center list-none'>Innovative Design Thinker</li>
                            </ul>
