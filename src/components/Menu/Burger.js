...
const Burger = () => {
  ...
  const transProp = isOpen ? 'transition duration-[20000] ease-out  px-6 py-2 flex flex-col justify-around items-start border-2 border-red-600 w-[60vw] h-[60vh] fixed top-0 right-0 bg-[#16B0B2] translate-x-[0%]' : 'px-6 py-2 flex flex-col justify-start items-start border-2 border-red-600 w-[60vw] h-[60vh] fixed top-0 right-0 bg-[#16B0B2] translate-x-[100%] transition duration-[30000] ease-out ';

  console.log(transProp);
  return (
    <div className='transition-all duration-[20000]'>
      <div className='fixed right-[60px] top-[20px] z-10 text-gray-600'><Hamburger toggled={isOpen} toggle={setOpen} /></div>
